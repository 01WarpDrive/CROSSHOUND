...
# fraction = 8 * 1024**3 / total_memory  # 8 GB in bytes
# torch.cuda.set_per_process_memory_fraction(fraction, device=0)
# print(f"[INFO] Set GPU memory limit to 8GB (fraction={fraction:.3f}) on device 0")
...
def main_optimized():
    ...
    threshold = 91.10735867309342 # 65.33643966674799
    anomalies = set()
    ...
    OUTPUT_FILE = f'{dataset_path}net_alarms_stream.txt'
    print(f"net anomalies: {len(anomalies)} \nhost related anomalies num: {len(anomaly_ecar)}")
